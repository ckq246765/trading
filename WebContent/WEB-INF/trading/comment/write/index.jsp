...
$(document).ready(function(){
	...
	function getAllObject(pageNo,pageSize,userCode) {
		$("#tBody").html("");
		$.post(
				"user/jump/comment/getAllWriteCommentByUser.do",
				{
					"pageNo":pageNo,
					"pageSize":pageSize,
					"userCode":userCode,
				...
				function (data) {
					...
					$(data.cList).each(function(i,n){
						...
						html += '<tr>';
						html += '<td objectCode="'+n.objectCode+'"><img src="${pageContext.request.contextPath }/'+n.picture_descri+' width="100" height="100" title="点击查看物品详细信息" /></td>';
						...
						html += '<td class="id"><input class="del" type="button" evaluateCode="'+n.evaluateCode+'"  objectCode="'+n.objectCode+'" evaluateUser="'+n.evaluateUser+'" orderCode="'+n.orderCode+'" value="删除评价"></td>';
						html += '</tr>';
					});
					$("#tBody").html(html);
					//分页
